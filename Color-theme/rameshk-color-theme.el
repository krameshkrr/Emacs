(defun color-theme-rameshk-black ()
  "Color theme by Ramesh Kandasamy."
  (interactive)
  (color-theme-install
   '(color-theme-rameshk-black
     ...
     (cperl-array-face ((t (:bold t :foreground "medium slate blue" :weight bold))))
     (cperl-hash-face ((t (:italic t :bold t :foreground "medium slate blue" :slant italic :weight bold))))
     ...
     (custom-comment-face ((t (:background "light blue"))))
     (custom-comment-tag-face ((t (:foreground "light blue"))))
     ...
     (font-lock-keyword-face ((t (:bold t :foreground "yellow" :weight bold))))
